    ...
    function appendChild(parent, child) {
     ...
     function getFirstElementByClass(className) {
        ...
        calendarElement.style.top = offset + elemRect.height + 64 + 'px';
