        ...
        <div class="col">
          <div class="card-wrapper">
            ...
            <div class="card">
              ...
              <form class="needs-validation" novalidate  action="<?php echo URL . 'ville/update/' . $ville->Id_Ville; ?>" method="post">
 
                  <div class="form-group">
                    <label class="form-control-label" for="validationCustom01">Nom de la Ville</label>
                      <input type="text" class="form-control" name="NomVille" id="validationCustom01" value="<?php if (isset($ville->NomVille)) echo $ville->NomVille; ?>" placeholder="Nom de Ville"  required>
                      <div class="invalid-feedback">
                        Please choose a Ville.
                      </div>
                  </div>

                  <button class="btn btn-primary" name="submit_edit_ville" type="submit">Update City</button>
                </form>
              </div>
            </div>
