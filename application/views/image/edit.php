        ...
        <div class="col">
          <div class="card-wrapper">
            ...
            <div class="card">
              ...
              <form class="needs-validation" novalidate  action="<?php echo URL . 'image/update/' . $image->Id_Image; ?>" method="post" enctype="multipart/form-data">

                <div >
                  <label class="form-control-label" for="validationCustom01">Nom Image</label>
                      <input type="text" class="form-control" name="NomImage" value="<?php if (isset($image->NomImage)) echo $image->NomImage; ?>" id="validationCustom01" placeholder="Nom Hotel"  required>
                  ...
                  <div class="form-group">
                    ...
                    <select class="form-control" name="Id_Hotel" id="exampleFormControlSelect1">
                     ...
                     <?php if ($hotel->Id_Hotel == $image->Id_Hotel) { ?>
                  ...
                  <button class="btn btn-primary" name="submit_edit_image" type="submit">Update Image</button>
                </form>
              </div>
            </div>
