          ...
          <div class="card-wrapper">
            ...
            <div class="card">
              ...
              <div class="card-body">
                ...
                <form class="needs-validation" novalidate  action="<?php echo URL; ?>category/store" method="post">
                  ...
                  <button class="btn btn-primary"  name="submit_add_category" type="submit">Add Category</button>
                </form>
              </div>
            </div>
